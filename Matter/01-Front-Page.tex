\newcommand\BackgroundPicFrontPage{%
	\put(0,0){%
		\parbox[b][\paperheight]{\paperwidth}{%
			\vfill
			\centering
			\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{Figures/Theme/Cover_Centrale_Claire.pdf}%
			\vfill
		}}}
...
\begin{titlepage}
	...
	\ifthenelse{\equal{\SchoolOption}{estg}}{
		\begin{figure}
			\includegraphics[width=0.485\linewidth]{Figures/Theme/Logotypes/LogoCN_Q.pdf}
		\end{figure}
	}
